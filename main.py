...
def get_argument_parser():
    ...
    parser.add_argument('--dataset', default="nuswide_10", type=str, help='')
    ...
    parser.add_argument("--warmup", type=int, default=3, help="")
    parser.add_argument("--IregionK", type=int, default=45 , help="image Region")
    parser.add_argument("--nearK", type=int, default=4, help="low sample k")
